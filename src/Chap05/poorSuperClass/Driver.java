...
public class Driver {
    public static void main(String[] args) {
        ...
        사람 한군인 = new 군인 ("한군인", new Date(1998, 12, 31), "19981231-1234567", "19-12345678");

        System.out.println(김학생.이름);
        System.out.println(한군인.이름);

        //System.out.println(김학생.생일); //사용불가
        //System.out.println(한군인.생일); //사용불가

        System.out.println(((학생) 김학생).생일); // 캐스팅 필요
        System.out.println(((군인) 한군인).생일); // 캐스팅 필요
        ...
        // 캐스팅 필요
        System.out.println(((군인) 한군인).주민등록번호);
        // 캐스팅 필요
